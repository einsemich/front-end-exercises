const menu = [
  ...
  const addButton =()=>{
    buttons.innerHTML=
    createbutton("All")+""+createbutton("Korea")+""+createbutton("Japan")+""+createbutton("China");
  };
  addButton();
  
  const btnAll   = document.querySelector("#All").addEventListener("click", listAllFoods);
  const btnKorea = document.querySelector("#Korea").addEventListener("click", listKoreaFoods);
  ...
  function listChinaFoods(){
    ...
    menu.map((x)=>{
      if ( x.category == "China"){
        chinaMenu += createObject(x)
      }
    });
    sections.innerHTML = chinaMenu
  }
  ...
  function listKoreaFoods() {
    ...
    menu.map((x) => {
      if (x.category == "Korea") {
        koreaMenu += createObject(x);
      }
    });
    sections.innerHTML = koreaMenu;
  }
  ...
  function listJapanFoods(){
    ...
    menu.map((x)=>{
      if (x.category == "Japan"){
        japanMenu += createObject(x)
      }
    });
    sections.innerHTML = japanMenu
  }
